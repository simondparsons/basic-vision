...
#
# but with half the number of filters at each convolution layer. This
# is my own invention (to quote the White Knight from 'Through the
# Looking Glass'), with a number of filters that splits the difference
# between the VGG8 models I have found elsewhere.
#
# Like my other reimplementations, it uses batch normalization and dropout.
...
class VGG8(Backbone):
    ...
    model = models.Sequential(name='VGG8')
