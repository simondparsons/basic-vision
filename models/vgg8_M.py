...
#
# and extends it to the description of what is called the Medium CNN here:
#
...
class VGG8_M(Backbone):
    ...
    nfilters_hidden2 = 256  # Then 256 filters
    nfilters_hidden3 = 512  # Finish with another layer with twice as many filters.

    # Define how we will build the model
    model = models.Sequential(name='VGG8_M')
