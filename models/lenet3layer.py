...
# normalization; and 3) a third layer. The third layer provides a
# minimalist version of the network here:
#
# commons.wikimedia.org/wiki/File:The-architecture-of-each-CNN-in-the-triplet-network.png
#
# which is typical of the structure of other early CNNs and allows us
# to test the effect of a slightly deeper model.

from models.backbone import Backbone 
from tensorflow.keras import layers, models

class LeNet3layer(Backbone):
    ...
    model = models.Sequential(name='LeNet-3layer')
