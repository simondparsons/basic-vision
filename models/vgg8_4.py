...
class VGG8_4(Backbone):
    ...
    nfilters_hidden1 = 64  # Start with 128 convolution filters to train
    nfilters_hidden2 = 128 # Then twice as many filters to train
    nfilters_hidden3 = 256 # Then twice as many filters again. 

    # Define how we will build the model
    model = models.Sequential(name='VGG8_4')
    ...
    def buildModel(self):
        ...
        # Add the first pair of convolution layers. These have 64
        # filters
        self.model.add(
            layers.Conv2D(
