...
#
# Thorat, P., Tongaonkar, R. and Jagtap, V., 2020. Towards designing
# the best model for classification of fish species using deep neural
# networks. In Proceeding of International Conference on Computational
# Science and Applications: ICCSA 2019 (pp. 343-351). Springer
# Singapore.
#
# This is one of a number of alternative descriptions of networks
# going under the name VGG8. The convolutional layers follow a similar
# pattern to those of VGG11, but with half the number of filters at
# each convolutional layer.
#
# Note that the source here mentions batch normalization and dropout,
# but does not say explicitly where BN occurs.

from models.backbone import Backbone 
from tensorflow.keras import layers, models

class VGG8_5(Backbone):
    ...
    model = models.Sequential(name='VGG8_5')
    ...
    def buildModel(self):
        ...
        # Add the first convolution layers. This has 32 filters
        self.model.add(
            layers.Conv2D(
        ...
        # The source paper says that there are 512 units here.
        self.model.add(
            layers.Dense(
                units=512,
                activation=self.activation,
